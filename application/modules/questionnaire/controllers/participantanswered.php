...
class ParticipantAnswered extends Admin_Controller {
    ...
    public function __construct() {
            ...
            // Load User Questionnaire Answer model
    ...
    public function index() {
        try {
            ...
            // Set tables
            $crud->set_table($this->QuestionnaireUserAnswers->table);
            // Set CRUD subject
            $crud->set_subject('User Questionnaire Answer');
            // Set column
			$crud->columns('participant_id','user_questionnaire_id','question_id','status','added','modified');

            // Set table relation
            $crud->set_relation('participant_id','tbl_participants','email',array('status' => 'active'),'priority ASC');
            // Set table relation
            $crud->set_relation('question_id','tbl_questions','name',array('status' => 'active'),'priority ASC');
            // Set table relation
            $crud->set_relation('user_questionnaire_id','tbl_questionnaires','name',array('status' => 'active'),'priority ASC');
            ...
            // Set column display
            $crud->display_as('user_questionnaire_id','Questionnaire');
