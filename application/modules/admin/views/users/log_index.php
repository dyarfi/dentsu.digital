				...
				<!-- BEGIN EXAMPLE TABLE PORTLET-->
					...
					<div class="portlet-body">
						<div class="table-toolbar">
							<div class="btn-group">
								<a class="btn green" id="sample_editable_1_new" href="<?=base_url(ADMIN.'log/add');?>">
				...
				<div class="table">
					<table id="sample_2" class="table table-striped table-bordered table-hover dataTable" aria-describedby="sample_2_info">
						...
						<tr role="row">
						    ...
						    <th class="sorting_disabled" role="columnheader" aria-controls="sample_2" tabindex="4" rowspan="1" colspan="1" style="width: 120px;" aria-label="Status : activate to sort column ascending">Modified
						    </th>
						    <th class="sorting_disabled" role="columnheader" aria-controls="sample_2" tabindex="4" rowspan="1" colspan="1" style="width: 120px;" aria-label="Status : activate to sort column ascending">Status
						    </th>
						...
						<tbody role="alert" aria-live="polite" aria-relevant="all">								
							...
							<tr class="odd gradeX <?php echo ($i % 2) ? 'even' : 'odd'; ?>">
								...
								<td class=" "><?php echo $row->user_agent;?></td>
