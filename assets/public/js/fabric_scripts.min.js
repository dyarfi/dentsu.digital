...
(function(){function d(a,c){a=void 0===a?"":a;c=void 0===c?"":c;""==a&&null!=document.getElementById("canva-row")?(b.setWidth(document.getElementById("canva-row").offsetWidth),b.setHeight(document.getElementById("canva-row").offsetHeight)):(b.setWidth(a),b.setHeight(c))}function c(a){fabric.Image.fromURL(a,function(a){b.add(a.set({left:110,top:110}).scale(.5))})}var b=new fabric.Canvas("canvas");b.backgroundColor="white";$("#canva-row").hide();$(".item-handler").hide();null!=document.getElementById("fileupload")&&
(document.getElementById("fileupload").onchange=function(a){var c=new FileReader;$("#canva-row").show();$(".item-handler").show();c.onload=function(a){$(".button-submit").show({duration:"260",easing:"easeInOutBack"});var c=new Image;c.src=a.target.result;c.onload=function(){var a=new fabric.Image(c);d(a.width,a.height);a.set("selectable",!1);b.add(a);b.centerObject(a)}};c.readAsDataURL(a.target.files[0])});window.addEventListener("resize",d,!0);initAligningGuidelines(b);initCenteringGuidelines(b);
b.observe("object:modified",function(a){});$(".menu img, .menu > img").on("click",function(){c(this.src)});$("#saveToPng").on("click",function(){b.setActiveGroup(new fabric.Group(b.getObjects())).renderAll();var a=b.getActiveGroup();b.discardActiveObject().renderAll();b.discardActiveGroup().renderAll();var c=document.createElement("canvas"),d=c.getContext("2d");c.width=a.width+60;c.height=a.height+60;var f=a.left-a.width/2-30,k=a.top-a.height/2-30;0>f&&(f=0);0>k&&(k=0);d.drawImage(b.getElement(),
f,k,a.width+60,a.height+60,0,0,a.width+60,a.height+60);Canvas2Image.saveAsJPEG(c)});$("#delete").on("click",function(){b.remove(b.getActiveObject())});$("#addText").on("click",function(){var a=new fabric.Text($("#canvaText").val(),{left:210,top:110});b.add(a)});$("#text-bold").click(function(){var a=b.getActiveObject();a&&"text"===a.type&&(a.fontWeight="bold"==a.fontWeight?"":"bold",b.renderAll())});$("#text-italic").click(function(){var a=b.getActiveObject();a&&"text"===a.type&&(a.fontStyle="italic"==
a.fontStyle?"":"italic",b.renderAll())});$("#text-strike").click(function(){var a=b.getActiveObject();a&&"text"===a.type&&(a.textDecoration="line-through"==a.textDecoration?"":"line-through",b.renderAll())});$("#text-underline").click(function(){var a=b.getActiveObject();a&&"text"===a.type&&(a.textDecoration="underline"==a.textDecoration?"":"underline",b.renderAll())});$("#text-left").click(function(){var a=b.getActiveObject();a&&"text"===a.type&&(a.textAlign="left",b.renderAll())});$("#text-center").click(function(){var a=
b.getActiveObject();a&&"text"===a.type&&(a.textAlign="center",b.renderAll())});$("#text-right").click(function(){var a=b.getActiveObject();a&&"text"===a.type&&(a.textAlign="right",b.renderAll())});$("#font-family").change(function(){var a=b.getActiveObject();a&&"text"===a.type&&(a.fontFamily=this.value,b.renderAll())});$("#text-bgcolor").miniColors({change:function(a,c){var d=b.getActiveObject();d&&"text"===d.type&&(d.backgroundColor=this.value,b.renderAll())},open:function(a,b){},close:function(a,
b){}});$("#text-fontcolor").miniColors({change:function(a,c){var d=b.getActiveObject();d&&"text"===d.type&&(d.fill=this.value,b.renderAll())},open:function(a,b){},close:function(a,b){}});$("#text-strokecolor").miniColors({change:function(a,c){var d=b.getActiveObject();d&&"text"===d.type&&(d.strokeStyle=this.value,b.renderAll())},open:function(a,b){},close:function(a,b){}});$("#send_image").click(function(a){a.preventDefault();var c=$(this).next(".msg");b.discardActiveGroup();b.discardActiveObject();
b.renderAll();$.ajax({url:base_URL+"upload/upload_result?type=fabric",type:"POST",dataType:"json",data:{data:b.toDataURL("image/png"),_token:$('meta[name="csrf-token"]').attr("content")},complete:function(a,b){var d=$.parseJSON(a.responseText);c.empty();c.html('<div class="alert alert-danger msg"><button class="close" data-close="alert"></button>'+d.result.text+"</div>");1===d.result.code&&setTimeout(function(){window.location.href=base_URL+"fabric"},2E3);"success"==b&&alert("saved!")}})})})();
